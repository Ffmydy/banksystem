	...
	<div class="menu-right">
		...
		<div class="table" id="table">
			<table border="1px">
				...
				<tr>
					<td>${irrigation_water_requirement.water_requirement_id }</td>
					<td>${irrigation_water_requirement.year }</td>
					<td>${irrigation_water_requirement.month }</td>
					<td>${irrigation_water_requirement.water_requirement}</td>
				</tr>
			</table>
		</div>
	</div>
