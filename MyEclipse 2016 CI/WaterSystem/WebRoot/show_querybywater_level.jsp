	...
	<div class="query">
		...
		<div class="table">
			<table border="1px" >
				...
				<tr>
						<td colspan="7"><a
							href="querybywater_level.do?pageNumber=1&pageSize=6&water_level=${water_level }">首页</a>| <a
							href="querybywater_level.do?pageNumber=${PageInfo.pageNumber-1 }&pageSize=${PageInfo.pageSize }&water_level=${water_level }"
