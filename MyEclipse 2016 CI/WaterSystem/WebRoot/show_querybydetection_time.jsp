	...
	<div class="query">
		...
		<div class="table">
			<table border="1px" >
				...
				<tr>
						<td colspan="7"><a
							href="querybydetection_time.do?pageNumber=1&pageSize=6&detection_time=${detection_time }">首页</a>| <a
							href="querybydetection_time.do?pageNumber=${PageInfo.pageNumber-1 }&pageSize=${PageInfo.pageSize }&detection_time=${detection_time }"
