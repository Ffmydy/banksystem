...
<body>
	...
	<div class="text">
		...
		<p>
		     万佛湖水资源管理系统，是就目前的万佛湖的水质项目检测，每年水库水资源需求量、蒸发量以及各水资源的各方面管理集成的大型水资源管理系统。主要针对水检项目的管理，万佛湖水资源需求量和蒸发量的监测。同时，查询水检单位的具体信息和认证水质检查报告。
		</p>
		<p>
		     该项目还未发行，开发者杜玉，作为毕业设计首次向公众展示，如有纰漏，还请见谅！
		</p>
	</div>
	</div>
</body>
