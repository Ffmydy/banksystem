	...
	<div class="menu-right">
		...
		<div class="table" id="table">
			<table border="1px">
				...
				<tr>
					<td>${count_requirement_bymonth.month }</td>
					<td>${count_requirement_bymonth.month_water_requirement }</td>
					<td>${count_requirement_bymonth.month_average_water_requirement }</td>
				</tr>
			</table>
		</div>
	</div>
